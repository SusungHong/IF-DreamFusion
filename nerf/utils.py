    ...
    def train_step(self, data):
        ...
        # novel view loss
            ...
            if self.opt.guidance == 'deepfloyd-if':
                ...
                polar = data['polar'] # [-90, 30]
                quad = (int(azimuth) + 45) % 360 // 90

                if polar <= -30:
                    pos_z = self.text_z['overhead']
                elif quad == 0:
                    pos_z = self.text_z['front']
                elif quad == 1 or quad == 3:
                    pos_z = self.text_z['side']
                elif quad == 2:
                    pos_z = self.text_z['back']
                ...
                loss = self.guidance.train_step(text_z, pred_rgb, as_latent=False, guidance_scale=self.opt.guidance_scale, grad_scale=self.opt.lambda_guidance)

            elif self.opt.guidance == 'stable-diffusion':
                # interpolate text_z
                azimuth = data['azimuth'] # [-180, 180]
